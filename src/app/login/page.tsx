  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-background p-6">
      <motion.div 
        ...
        className="max-w-md w-full border-2 border-border p-10 bg-card shadow-[20px_20px_0px_rgba(0,0,0,0.1)]"
      >
        <div className="mb-10">
          ...
          <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.3em]">Identity Verification Required for Checkout</p>
        </div>

        <button 
          onClick={() => signIn("github", { callbackUrl: "/shop" })}
        ...
        >
          Initialize GitHub Auth <ArrowRight className="w-4 h-4 group-hover:translate-x-2 transition-transform" />
        </button>
